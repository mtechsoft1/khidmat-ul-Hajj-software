...
class Invoice extends Model
{
    ...
    public function isHotelReservation(): bool
    {
        return ! empty($this->category?->name)
            && mb_strtolower($this->category->name) === mb_strtolower(Category::HOTEL_RESERVATION);
    }
}
