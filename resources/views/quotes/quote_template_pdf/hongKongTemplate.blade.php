                        ...
                        <table class="overflow-hidden w-100">
                            <tr>
                                ...
                                <td class="text-end pr-5">
                                    <div class="">
                                        <img width="100px" src="{{ getLogoUrl() }}" class="img-logo">
                                    </div>
                                    <div>
                    ...
                    <table class="invoice-table w-100">
                        <thead {{ $styleCss }}="background-color: {{ $invoice_template_color }};">
                            <tr>
                                ...
                                <th class="p-2 text-center text-nowrap text-uppercase" style="width:16% !important;">
                                    {{ __('messages.product.unit_price') }}</th>
                                <th class="p-2 text-end text-nowrap text-uppercase" style="width:18% !important;">
                    ...
                    <div class="my-10">
                        <table class=" w-100">
                            <tr>
                                ...
                                <td class="w-50" style="vertical-align:top; width: 40% !important;">
