                        ...
                        <div class="row">
                            <div class="col-xxl-9">
                                <div class="row">
                                    ...
                                    @if ($invoice->isHotelReservation())
                                        <div class="col-12">
                                            <div class="card border mt-3 mb-5">
                                                <div class="card-body">
                                                    <h5 class="mb-4">Hotel Reservation Information</h5>
                                                    <div class="row">
                                                        <div class="col-md-3"><strong>Reservation #:</strong> {{ $invoice->reservation_number ?? 'N/A' }}</div>
                                                        <div class="col-md-3"><strong>Reservation Date:</strong> {{ $invoice->reservation_date ?? 'N/A' }}</div>
                                                        <div class="col-md-3"><strong>Reservation ID:</strong> {{ $invoice->reservation_reference ?? 'N/A' }}</div>
                                                        <div class="col-md-3"><strong>User ID:</strong> {{ $invoice->reservation_user_id ?? 'N/A' }}</div>
                                                        <div class="col-md-4 mt-3"><strong>Email:</strong> {{ $invoice->reservation_email ?? 'N/A' }}</div>
                                                        <div class="col-md-4 mt-3"><strong>Lead Pax:</strong> {{ $invoice->lead_pax ?? 'N/A' }}</div>
                                                        <div class="col-md-4 mt-3"><strong>Nationality:</strong> {{ $invoice->nationality ?? 'N/A' }}</div>
                                                        <div class="col-md-4 mt-3"><strong>Hotel:</strong> {{ $invoice->hotel_name ?? 'N/A' }}</div>
                                                        <div class="col-md-4 mt-3"><strong>Check In:</strong> {{ $invoice->hotel_check_in ?? 'N/A' }}</div>
                                                        <div class="col-md-4 mt-3"><strong>Check Out:</strong> {{ $invoice->hotel_check_out ?? 'N/A' }}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
