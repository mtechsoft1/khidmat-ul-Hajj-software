...
class InvoiceRepository extends BaseRepository
{
    ...
    public function getSyncList($invoice = []): array
    {
        ...
        $data['categories'] = Category::orderBy('name')->pluck('name', 'id')->toArray();
    ...
    public function saveInvoice(array $input): Invoice
    {
        try {
            ...
            $input = Arr::only($input, [
                ...
                'category_id', 'reservation_number', 'reservation_date', 'reservation_reference', 'reservation_user_id',
                'reservation_email', 'lead_pax', 'nationality', 'hotel_name', 'hotel_check_in', 'hotel_check_out',
                'no_of_nights', 'meal_type', 'special_remarks', 'meal_per_pax', 'municipality_tax',
            ]);
