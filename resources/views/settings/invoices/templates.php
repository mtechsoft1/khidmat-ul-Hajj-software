                        ...
                        <table class="my-10">
                            <tbody>
                                 <tr style="vertical-align:top;">
                                    ...
                                    <td width="33.33%;" class="text-end">
                                        <p class="mb-1 font-gray-600 fs-6"><strong class="font-gray-900">Invoice Date: </strong>2023-01-01</p>
                                        <p class=" mb-1 font-gray-600 fs-6"><strong  class="font-gray-900">Due Date: </strong>2023-01-02</p>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <div class="px-10">
                        ...
                        <table class="invoice-table">
                            <thead style="background-color: {{:invColor}};">
                                <tr>
                                    ...
                                    <th class="p-2 in-w-2 text-uppercase text-nowrap"><b><?php echo __('messages.item') ?></b></th>
                    ...
                    <div class="my-10">
                        <table>
                             <tr>
                                <td>
                                    <p class="m-0 fs-6 font-orange" style="color:{{:invColor}}"><b><?php echo __('messages.payment_qr_codes.payment_qr_code') ?></b></p>
                                    <img class="mt-4" src="<?php echo asset('images/qrcode.png') ?>" height="100" width="100">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="w-50" style="vertical-align:top;">
                                    <table class="w-100">
                                        <tbody>
                                            <tr>
                                                <td class="text-nowrap py-1 px-2 text-yellow"  style="color:{{:invColor}}">
                                                    <strong><?php echo __('messages.invoice.amount') ?></strong>
                                                </td>
                                                <td class="text-nowrap text-end font-gray-600 py-1 px-2 fw-bold">
                                                    <?php echo getCurrencyAmount(300, true) ?>
