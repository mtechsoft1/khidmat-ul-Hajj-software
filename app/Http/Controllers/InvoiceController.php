...
class InvoiceController extends AppBaseController
{
    ...
    public function convertToPdf(Invoice $invoice): Response
    {
        ...
        $invoice->load(['client.user', 'category', 'invoiceTemplate', 'invoiceItems.product', 'invoiceItems.invoiceItemTax', 'invoiceTaxes', 'paymentQrCode']);
        $invoiceData = $this->invoiceRepository->getPdfData($invoice);
        $invoiceTemplate = $invoice->isHotelReservation() ? 'hotelReservationTemplate' : $this->invoiceRepository->getDefaultTemplate($invoice);
    ...
    public function getPublicInvoicePdf($invoiceId)
    {
        ...
        $invoice->load('client.user', 'category', 'invoiceTemplate', 'invoiceItems.product', 'invoiceItems.invoiceItemTax');
        $invoiceData = $this->invoiceRepository->getPdfData($invoice);
        $invoiceTemplate = $invoice->isHotelReservation() ? 'hotelReservationTemplate' : $this->invoiceRepository->getDefaultTemplate($invoice);
        $pdf = Pdf::loadView("invoices.invoice_template_pdf.$invoiceTemplate", $invoiceData);
