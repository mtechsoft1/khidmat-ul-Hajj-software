<div class="row gx-10 mb-5">
    <div class="col-lg-6">
        <div class="mb-5">
            ...
            {{ Form::text('first_name', null, ['class' => 'form-control', 'placeholder' => __('messages.vendor.first_name'), 'required']) }}
        </div>
    </div>
    <div class="col-lg-6">
        <div class="mb-5">
            {{ Form::label('last_name', __('messages.vendor.last_name') . ':', ['class' => 'form-label required mb-3']) }}
            {{ Form::text('last_name', null, ['class' => 'form-control', 'placeholder' => __('messages.vendor.last_name'), 'required']) }}
        </div>
    </div>
    <div class="col-lg-6">
        <div class="mb-5">
            {{ Form::label('email', __('messages.vendor.email') . ':', ['class' => 'form-label required mb-3']) }}
            {{ Form::email('email', null, ['class' => 'form-control', 'placeholder' => __('messages.vendor.email'), 'required']) }}
        </div>
    </div>
    <div class="col-lg-6">
        <div class="mb-5">
    ...
    <div class="col-lg-6">
        <div class="mb-5">
            ...
            {{ Form::select('country_id', $countries, null, ['id' => 'countryId', 'class' => 'form-select io-select2 ', 'placeholder' => __('messages.vendor.country'), 'data-control' => 'select2']) }}
        </div>
    </div>
</div>
