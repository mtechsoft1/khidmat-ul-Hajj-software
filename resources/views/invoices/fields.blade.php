<div class="row">
    ...
    <div class="col-lg-4 col-sm-12 mb-5">
        {{ Form::label('category_id', 'Category' . ':', ['class' => 'form-label required mb-3']) }}
        {{ Form::select('category_id', $categories, null, ['class' => 'form-select io-select2', 'id' => 'invoiceCategoryId', 'placeholder' => 'Select Category', 'data-control' => 'select2', 'required']) }}
    </div>
    ...
    <div id="hotelReservationFields" class="row d-none">
        ...
        <div class="mb-5 col-lg-3 col-sm-12">
            {{ Form::label('reservation_number', 'Reservation #:', ['class' => 'form-label mb-3']) }}
            {{ Form::text('reservation_number', null, ['class' => 'form-control']) }}
        </div>
        <div class="mb-5 col-lg-3 col-sm-12">
            {{ Form::label('reservation_date', 'Reservation Date:', ['class' => 'form-label mb-3']) }}
            {{ Form::date('reservation_date', null, ['class' => 'form-control']) }}
        </div>
        <div class="mb-5 col-lg-3 col-sm-12">
            {{ Form::label('reservation_reference', 'Reservation ID:', ['class' => 'form-label mb-3']) }}
            {{ Form::text('reservation_reference', null, ['class' => 'form-control']) }}
        </div>
        <div class="mb-5 col-lg-3 col-sm-12">
            {{ Form::label('reservation_user_id', 'User ID:', ['class' => 'form-label mb-3']) }}
            {{ Form::text('reservation_user_id', null, ['class' => 'form-control']) }}
        </div>
        <div class="mb-5 col-lg-4 col-sm-12">
            {{ Form::label('reservation_email', 'Email:', ['class' => 'form-label mb-3']) }}
            {{ Form::email('reservation_email', null, ['class' => 'form-control']) }}
        </div>
        <div class="mb-5 col-lg-4 col-sm-12">
            {{ Form::label('lead_pax', 'Lead Pax:', ['class' => 'form-label mb-3']) }}
            {{ Form::text('lead_pax', null, ['class' => 'form-control']) }}
        </div>
        <div class="mb-5 col-lg-4 col-sm-12">
            {{ Form::label('nationality', 'Nationality:', ['class' => 'form-label mb-3']) }}
            {{ Form::text('nationality', null, ['class' => 'form-control']) }}
        </div>
        <div class="mb-5 col-lg-4 col-sm-12">
            {{ Form::label('hotel_name', 'Hotel:', ['class' => 'form-label mb-3']) }}
            {{ Form::text('hotel_name', null, ['class' => 'form-control']) }}
        </div>
        <div class="mb-5 col-lg-4 col-sm-12">
            {{ Form::label('hotel_check_in', 'Check In:', ['class' => 'form-label mb-3']) }}
            {{ Form::date('hotel_check_in', null, ['class' => 'form-control']) }}
        </div>
        <div class="mb-5 col-lg-4 col-sm-12">
            {{ Form::label('hotel_check_out', 'Check Out:', ['class' => 'form-label mb-3']) }}
            {{ Form::date('hotel_check_out', null, ['class' => 'form-control']) }}
        </div>
        <div class="mb-5 col-lg-3 col-sm-12">
            {{ Form::label('no_of_nights', 'No. of Nights:', ['class' => 'form-label mb-3']) }}
            {{ Form::number('no_of_nights', null, ['class' => 'form-control', 'min' => 0]) }}
        </div>
        <div class="mb-5 col-lg-3 col-sm-12">
            {{ Form::label('meal_type', 'Meal Type:', ['class' => 'form-label mb-3']) }}
            {{ Form::text('meal_type', null, ['class' => 'form-control']) }}
        </div>
        <div class="mb-5 col-lg-3 col-sm-12">
            {{ Form::label('meal_per_pax', 'Meal Per Pax:', ['class' => 'form-label mb-3']) }}
            {{ Form::number('meal_per_pax', null, ['class' => 'form-control', 'min' => 0, 'step' => '.01']) }}
        </div>
        <div class="mb-5 col-lg-3 col-sm-12">
            {{ Form::label('municipality_tax', 'Municipality Tax:', ['class' => 'form-label mb-3']) }}
            {{ Form::number('municipality_tax', null, ['class' => 'form-control', 'min' => 0, 'step' => '.01']) }}
        </div>
        <div class="mb-5 col-12">
            {{ Form::label('special_remarks', 'Special Remarks:', ['class' => 'form-label mb-3']) }}
            {{ Form::text('special_remarks', null, ['class' => 'form-control']) }}
        </div>
    </div>
